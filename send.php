...
$imagen = $_POST["imagen"];
$plus3_regGP = $_POST["plus3_regGP"];
$plus3_regCA = $_POST["plus3_regCA"];
$plus3_regND = $_POST["plus3_regND"];
$plus3_regCD = $_POST["plus3_regCD"];
$plus3_regNA = $_POST["plus3_regNA"];
/*
echo $imagen;
echo "<br>";
echo $plus3_regGP;
...
$mensaje = '<b>Plus Factor 1</b><br><b>Student name: </b>'.$plus3_regNA.'<br><b>Group: </b> '.$plus3_regGP.'<br><b>Teacher: </b>'.$plus3_regND;

$para = $plus3_regCD;
$para2 = $plus3_regCA;
$asunto = 'Plus Factor 3: Activity';				
